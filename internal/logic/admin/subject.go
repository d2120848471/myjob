...
func (l *SubjectLogic) List(ctx context.Context, _ *v1.SubjectListReq) (*v1.SubjectListRes, error) {
	...
	return &v1.SubjectListRes{List: items}, nil
}

func (l *SubjectLogic) Add(ctx context.Context, req *v1.SubjectCreateReq, actor app.AdminUser, ip string) (*v1.SubjectCreateRes, error) {
	...
	return &v1.SubjectCreateRes{ID: id}, nil
}

func (l *SubjectLogic) Edit(ctx context.Context, req *v1.SubjectUpdateReq, actor app.AdminUser, ip string) (*v1.SubjectUpdateRes, error) {
	req.Name = strings.TrimSpace(req.Name)
	if req.Name == "" || (req.HasTax != 0 && req.HasTax != 1) {
		return nil, apiErr(consts.CodeBadRequest, "主体参数错误")
	}
	...
	return &v1.SubjectUpdateRes{}, nil
}
